...
function Home() {
    ...
    return (
        <div className="overflow-x-hidden">
            {/* Hero Section */}
            <section className="min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-16 lg:px-24 max-w-7xl mx-auto pt-20">
                {/* Status Badge */}
                <div className="mb-6 sm:mb-8">
                    <span className="inline-block px-3 sm:px-4 py-2 border-2 border-black text-[10px] sm:text-xs tracking-widest">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 bg-black text-white px-6 py-3 text-xs font-semibold tracking-widest hover:bg-black/80 transition-colors"
                    >
                        VIEW PROJECTS
                    </button>
                    <button
                        onClick={() => navigate("/connect")}
                        className="flex items-center justify-center gap-2 border-2 border-black text-black px-6 py-3 text-xs font-semibold tracking-widest hover:bg-black hover:text-white transition-all"
                    >
                        LET'S CONNECT
                    </button>
                </div>
            ...
            <section className="bg-[#f4f4f5] px-4 sm:px-6 md:px-16 lg:px-24 py-12 sm:py-20">
                {/* Two Card Layout */}
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 border-b-2 border-black">
                            ...
                            <span className="text-[10px] sm:text-xs font-bold tracking-widest">ABOUT_ME</span>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 border-b-2 border-black">
                            ...
                            <span className="text-[10px] sm:text-xs font-bold tracking-widest">TECH_STACK</span>
                            <div className="flex items-center gap-2 text-black/40">
                                <span className="text-[10px] sm:text-xs">—</span>
                                <span className="text-[10px] sm:text-xs">□</span>
                            </div>
                        ...
                        <div className="p-4 sm:p-6 md:p-8">
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                                {allTechItems.map((item, index) => (
                                    <div
                                        key={index}
                                        className="px-2 sm:px-3 py-2 sm:py-2.5 border-2 border-black text-center text-[10px] sm:text-xs font-medium hover:bg-black hover:text-white transition-all cursor-default"
                                    >
                                        {item}
                                    </div>
                                ))}
